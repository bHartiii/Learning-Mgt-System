...
from learning_mgt.views import UpdateStudentDetails, UpdateEducationDetails, Courses, CourseDetails,Mentors 
...
urlpatterns = [
    ...
    path('mentor/<int:mentor_id>', Mentors.as_view(), name='mentor'),
]
